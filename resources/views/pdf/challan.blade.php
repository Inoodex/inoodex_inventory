...
<head>
    ...
    @php
        $padBase64 = getPdfBackground($company ?? ($challan->companyDetail ?? null), 'invoice');
    @endphp
    <style>
        @page {
            @if($padBase64)
    ...
    <table class="header-table" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td style="width:20%; text-align: center; vertical-align: top;">
                <barcode code="{{ route('document.verify', ['type' => 'challan', 'code' => $challan->reference_number ?? $challan->id]) }}" type="QR" class="barcode" size="0.75" error="M" disableborder="1" />
                <div style="font-size: 7.5px; color: #64748b; margin-top: 2px;">Verify Challan</div>
            </td>
