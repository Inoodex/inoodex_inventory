...
<div class="content container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="content-page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h4 class="card-title fw-bold text-dark mb-1">Edit Company Details</h4>
                <p class="text-muted small mb-0">Update profile, authorized signatory, letterhead pad, and document settings for <strong>{{ $companyDetail->name }}</strong></p>
            </div>
            <div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $companyDetail->name) }}" placeholder="e.g. Inoodex Solutions Ltd" required>
                                @error('name')
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $companyDetail->phone) }}" placeholder="e.g. +880 1700-000000">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $companyDetail->email) }}" placeholder="e.g. info@inoodex.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="website" class="form-control @error('website') is-invalid @enderror" value="{{ old('website', $companyDetail->website) }}" placeholder="e.g. https://inoodex.com">
                                @error('website')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="3" placeholder="Full registered company office address...">{{ old('address', $companyDetail->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" name="signatory_name" class="form-control @error('signatory_name') is-invalid @enderror" value="{{ old('signatory_name', $companyDetail->signatory_name) }}" placeholder="e.g. John Doe" required>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" name="signatory_designation" class="form-control @error('signatory_designation') is-invalid @enderror" value="{{ old('signatory_designation', $companyDetail->signatory_designation) }}" placeholder="e.g. Managing Director" required>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div id="preview_signature" class="preview-box {{ $companyDetail->signature_image ? 'has-image' : '' }}">
                                    @if ($companyDetail->signature_image && file_exists(public_path($companyDetail->signature_image)))
                                        <img src="{{ asset($companyDetail->signature_image) }}" alt="Signature">
                                    @else
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div id="preview_seal" class="preview-box {{ $companyDetail->seal_image ? 'has-image' : '' }}">
                                    @if ($companyDetail->seal_image && file_exists(public_path($companyDetail->seal_image)))
                                        <img src="{{ asset($companyDetail->seal_image) }}" alt="Seal">
                                    @else
                                        <i class="fe fe-shield fs-3 text-muted mb-1"></i>
                                        <span class="text-muted small">No seal uploaded</span>
                                    @endif
                                </div>
                                <small class="text-muted fs-8">Transparent PNG recommended (Max 2MB)</small>
                            </div>
                ...
                <div class="card card-custom bg-white mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="preview_pad" class="preview-box {{ $companyDetail->pad_image ? 'has-image' : '' }}">
                                @if ($companyDetail->pad_image && file_exists(public_path($companyDetail->pad_image)))
                                    <img src="{{ asset($companyDetail->pad_image) }}" alt="Invoice Pad">
                                @else
                                    <i class="fe fe-file-text fs-3 text-muted mb-1"></i>
                                    <span class="text-muted small">No custom pad uploaded (system fallback active)</span>
                                @endif
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="preview_report_bg" class="preview-box {{ $companyDetail->report_bg_image ? 'has-image' : '' }}">
                                @if ($companyDetail->report_bg_image && file_exists(public_path($companyDetail->report_bg_image)))
                                    <img src="{{ asset($companyDetail->report_bg_image) }}" alt="Report Background">
                                @else
                                    <i class="fe fe-bar-chart-2 fs-3 text-muted mb-1"></i>
                                    <span class="text-muted small">No custom report background uploaded</span>
                                @endif
                            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="toggle-card">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" name="show_invoice_bg" id="show_invoice_bg" value="1" {{ old('show_invoice_bg', $companyDetail->show_invoice_bg) ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="toggle-card">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" name="show_report_bg" id="show_report_bg" value="1" {{ old('show_report_bg', $companyDetail->show_report_bg) ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="toggle-card">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" name="is_default" id="is_default" value="1" {{ old('is_default', $companyDetail->is_default) ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="toggle-card">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $companyDetail->is_active) ? 'checked' : '' }}>
